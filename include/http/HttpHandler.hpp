...
namespace HttpHandler {
    ...
    void buildResponseForRequest(ClientConnection& client, const std::vector<ServerConfig>& servers, const WebServer* serverCtx);
    ...
    std::string resolvePath(const ServerConfig& cfg, const RouteConfig* route, const std::string& requestPath);
